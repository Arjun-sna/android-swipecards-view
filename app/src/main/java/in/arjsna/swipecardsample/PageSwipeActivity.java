...
public class PageSwipeActivity extends AppCompatActivity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    flingContainer.setFlingListener(new SwipePageView.OnPageFlingListener() {
      ...
      @Override public void onTopCardExit(Object dataObject) {
      }

      @Override public void onBottomCardExit(Object dataObject) {
      }
    });
